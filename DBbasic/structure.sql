...
ALTER TABLE `card`
MODIFY `idcard` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=45;
ALTER TABLE `customer`
...
ALTER TABLE `discounts`
MODIFY `idDiscounts` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
ALTER TABLE `employee`
...
ALTER TABLE `orderitem`
MODIFY `idorderItem` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=35;
ALTER TABLE `payment`
MODIFY `idPayment` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=68;
ALTER TABLE `refund`
